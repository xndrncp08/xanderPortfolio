    ...
    <>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div>
            {/* Status badge */}
            <div className="xtr-fade-up" style={{ animationDelay: '0ms',
            ...
            {/* Role line */}
            <div className="xtr-fade-up" style={{ animationDelay: '140ms', display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
            ...
            <p className="xtr-fade-up" style={{
              ...
              color: muted, maxWidth: 500, margin: '0 0 36px',
            }}>
            ...
            {/* Buttons */}
            <div className="xtr-fade-up" style={{ animationDelay: '260ms', display: 'flex', gap: 14, flexWrap: 'wrap' }}>
            ...
            {/* Socials */}
            <div className="xtr-fade-up" style={{ animationDelay: '330ms', display: 'flex', gap: 20, marginTop: 36 }}>
              {[
          ...
          {/* Avatar */}
          <div className="xtr-float xtr-fade-in" style={{ animationDelay: '200ms', position: 'relative', flexShrink: 0 }}>
            {/* Gradient ring */}
            <div style={{
  ...
  return (
    <button onClick={onClick}
      ...
      style={{
        ...
        cursor: 'pointer', transition: 'all .25s', letterSpacing: '0.01em', color: '#fff',
        background: hov
  ...
  return (
    <button onClick={onClick}
      ...
      style={{
        ...
        cursor: 'pointer', transition: 'all .25s', letterSpacing: '0.01em',
